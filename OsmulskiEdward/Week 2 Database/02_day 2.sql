...
SELECT COUNT(ALL grade) count FROM customer;
...
#Sample Output:  max
#5760.00
SELECT MAX(purch_amt) max FROM orders;
...
SELECT MIN(purch_amt) min FROM orders;
...
#Berlin		100
#Moscow		200
SELECT city, MAX(grade) max FROM customer GROUP BY city;
...
#3003		75.29
#3005		948.50
SELECT customer_id, MAX(purch_amt) max FROM orders GROUP BY customer_id;
...
SELECT customer_id, ord_date, MAX(purch_amt) max FROM orders GROUP BY customer_id, ord_date;
...
#3009		2012-10-10	2480.40
#3002		2012-04-25	3045.60
SELECT customer_id, ord_date, MAX(purch_amt) max FROM orders WHERE purch_amt > 2000 GROUP BY  customer_id, ord_date;
...
#3009		2012-10-10	2480.40
#3002		2012-04-25	3045.60
SELECT customer_id, ord_date, MAX(purch_amt) max FROM orders WHERE purch_amt BETWEEN 2000 AND 6000 GROUP BY customer_id, ord_date;
...
#3003		75.29
#3005		948.50
SELECT customer_id, MAX(purch_amt) max FROM orders WHERE customer_id BETWEEN 3002 AND 3007 GROUP BY customer_id;
...
#3007		2400.60
#3004		1983.43
SELECT customer_id, MAX(purch_amt) max FROM orders WHERE customer_id BETWEEN 3002 AND 3007 AND purch_amt > 1000 GROUP BY customer_id;
...
#5007		75.29
#5006		1983.43
SELECT salesman_id, MAX(purch_amt) max FROM orders WHERE salesman_id BETWEEN 5003 AND 5008 GROUP BY salesman_id;
...
#count
#2
SELECT COUNT(*) count FROM orders WHERE ord_date = '2012-08-17';
...
#count
#6
SELECT COUNT(salesman_id) count FROM salesman;
...
#2012-10-05	5001		1
#2012-10-10	5006		1
SELECT ord_date, salesman_id, COUNT(*) count FROM orders GROUP BY ord_date, salesman_id; 
...
SELECT AVG(PRO_PRICE) "Average Price" FROM item_mast;
...
#Number of Products
#8
SELECT COUNT(*) "Number of Products" FROM item_mast WHERE PRO_PRICE >= 350;
...
SELECT AVG(PRO_PRICE) "Average Price", PRO_COM "Company ID" FROM item_mast GROUP BY PRO_COM;
...
#sum
#450000
SELECT SUM(DPT_ALLOTMENT) sum FROM emp_department;
...
#47			3
#63			3
SELECT EMP_DEPT emp_dept, COUNT(EMP_IDNO) count FROM emp_details GROUP BY EMP_DEPT;